import pytest
import numpy as np
from minipack.scenarios.uniform_stratified_strong_generalization import (
...
def test_stratified_strong_generalization_split(
    ...
    scenario = UniformStratifiedStrongGeneralization(
...
def test_stratified_strong_generalization_same_seed(
    ...
    scenario_1 = UniformStratifiedStrongGeneralization(
        num_users_test=num_users_test,
        num_users_val=num_users_val,
        num_users_est=num_users_est,
        bin_width=bin_width,
    ...
    scenario_2 = UniformStratifiedStrongGeneralization(
        num_users_test=num_users_test,
        num_users_val=num_users_val,
        num_users_est=num_users_est,
        bin_width=bin_width,
